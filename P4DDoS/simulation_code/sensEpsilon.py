...
for i in range(0, 50):
    ...
    if (Hnorm[i] < EWMA-epsilon3*1024):
        ddos3 = 1
    if (Hnorm[i] < EWMA-epsilon4*1024):
        ddos4 = 1
    if (Hnorm[i] < EWMA-epsilon5*1024):
        ddos5 = 1
    if (Hnorm[i] < EWMA-epsilon6*1024):
        ddos6 = 1
    if (Hnorm[i] < EWMA-epsilon7*1024):
        ddos7 = 1
    if (Hnorm[i] < EWMA-epsilon8*1024):
        ddos8 = 1
    if (Hnorm[i] < EWMA-epsilon9*1024):
        ddos9 = 1

    if i == 0:
        EWMA = Hnorm[i]
    else:
        EWMA = alpha * Hnorm[i] + (1-alpha)*EWMA
